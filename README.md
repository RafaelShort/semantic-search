...
| 🖥️ **Interface Web** | Interface Streamlit com cards de resultado, métricas e ingestão |
...
A interface foi construída com **Streamlit** e permite usar o sistema sem precisar interagir diretamente com a API.

**Painel lateral:**
- 🟢 Status em tempo real do MongoDB e ElasticSearch
- 📊 Estatísticas de documentos e chunks indexados
- 📥 Ingestão de documentos via URL ou upload de arquivo

**Área principal:**
- Seleção do modo de busca (Híbrida / Semântica / Palavras-chave)
- Campo de busca com botão integrado
- Opções avançadas: pesos semântico/keyword, nº de resultados, reranking
- Cards de resultado com score, barra de relevância e badge de modo
- Métricas de tempo de resposta por consulta
...
### 9. Acessar
- 🖥️ Interface Web (Streamlit):	http://localhost:8501
...
- Singleton com lru_cache:	Configurações e clientes inicializados uma única vez
